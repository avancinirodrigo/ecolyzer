...
def test_extract_first_commit():
	...
	calls = {
		...
		'RenderingHints.VALUE_ANTIALIAS_ON.equals': True,
		'RenderingHints.VALUE_ANTIALIAS_OFF.equals': True,
		...
		'JFreeChart.INFO.toString': True,
		'CloneNotSupportedException': True,
		'Object.clone': True,
		'RenderingHints.clone': True,
		'TextTitle.clone': True,
		'chart.title.addChangeListener': True,
		'chart.subtitles.add': True,
		'Plot.clone': True,
		'chart.plot.addChangeListener': True,
